...
#Parameters - NHPs
{
  #Basic reproduction number for transmission among NHPs (here a sine function giving regular seasonal variation)
...
#Parameters - human 
{
  #Basic reproduction number for human-human transmission (here a sine function giving regular seasonal variation)
