...
make_transform <- function(I0, S0, Temp, Temp_0, Temp_m, dt, t_pts) {
  function(theta) {
    c(list(I0 = I0, S0 = S0, Temp = Temp, Temp_0 = Temp_0, Temp_m = Temp_m, dt = dt, t_pts = t_pts), 
      as.list(theta))
  }
}
...
mcmc_pars <- pmcmc_parameters$new(priors, vcv, 
                                  transform=make_transform(I0 = gen_params$I0, S0 = gen_params$S0, Temp=gen_params$Temp,
                                                           Temp_0 = gen_params$Temp_0, Temp_m = gen_params$Temp_m,
                                                           dt = gen_params$dt, t_pts = gen_params$t_pts)) 
