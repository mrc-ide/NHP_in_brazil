...
beta <- exp(log_temp_scale)*Temp*(Temp-Temp_0)*(Temp_m-Temp)^0.5 #Briere formulation of Mordecai et al 2017
gamma <- exp(log_gamma)
...
log_temp_scale <- user() #to be estimated 
log_gamma <- user(0.1) #to be estimated
I0 <- user(10) #as input
